 ...
 * @author MouBieCat
 */
public record ChannelWrapper(@NotNull String prefix,
                             @NotNull SimpleChannel simpleChannel)
        implements Channel {
     ...
     * @param message 訊息
     */
    public void sendMessage(final @NotNull Player sender, final @NotNull String message) {
